...
## Edited by Cara Brook, 2020-2024
...
## Madagascar. Typical outbreaks produce similar patterns of cases in the two
## populations, and the outbreaks always occur simultaneously. DF became a reportable
## disease in Madagascar in 2016, and the Ministry of Health has enlisted your help
## to understand the data they have collected since that time.
##
## In 2016 and 2017 the outbreaks looked pretty similar. First, let's look at how the epidemics
## in dogs and people progressed in 2016:
...
## Overall, there were 759 canine cases and 786 human cases over a period of 16 weeks. In 2017,
...
plot.cases(data.2017)            # Plot epidemic curve for 2016

## In 2018, there was only one case in dogs and one in humans, but in 2019, another large
...
## Based on the data from 2016-2019, what have you learned about DF?  What factors might determine the
...
##
## A veterinary vaccine against DF had been approved for use in dogs in mid-2018, but since there was
## not a problem that year, the Ministry of Health did not promote it's use. Following the the disease's
## resurgence in 2019, however, information on the vaccine was sent to veterinarians and pet owners
## in an effort to encourage vaccine uptake. By the beginning of 2020, 40 percent of the dog population
## in Madagascar had been vaccinated.
##
## In 2020, the number of DF cases was substantially lower than in any year other than 2018, with only 34
...
## the disease as well. Other employees pointed out that there were more cases in 2020 than in 2018 (before
...
## outbreaks). This group concluded that the relatively small number of cases in 2020 could be unrelated to
...
## gotten sick in 2020, and by the beginning of 2021, 50 percent of the dog population in Madagascar had
## been vaccinated.
##
## As it turned out, the 2021 data did not clarify things for the Minister, and the debate within the department
## only grew more heated, with each side claiming that the 2021 data supported their argument:

plot.cases(data.2021)            # Plot epidemic curve for 2021

## In the first 17 weeks of 2021, 109 dogs and 213 people contracted DF.
##
...
##
## Luckily for the Minister of Health, the approval of a human vaccine against DF in mid-2021
...
## By the beginning of 2022, 50 percent of the people in Madagascar had been vaccinated, though dog vaccine
## uptake fell to 20 percent.
##
## Although the 2022 season got off to a slow start, the Minister was in for a surprise when the outbreak
## picked up later in the season. In the end, the 2022 outbreak was the worst one for years, with 480 canine
...
## time for the 2023 season as possible. By the beginning of the year, 80 percent of the people in Madagascar
...
## see so many canine cases in Madagascar in 2023:

plot.cases(data.2023)            # Plot epidemic curve for 2023

## In fact, there were more cases of DF in dogs in 2023 than in any year on record, with 812 canine cases,
...
## of the observed data? What would you advise the AD to do in order to prepare for the 2024 DF season?
##
## PART 4 - Moving forward
##
## Decide on target levels of vaccination for dogs and people in 2024, keeping in mind that it is unlikely that
...
target.2024 <- run.example(VaxPct.Dogs,VaxPct.Humans)

## Plot the cases through time to see what happened:

plot.cases(target.2024)
