...
ts.sir <- data.frame(lsoda(
  ...
  times = seq(0,365,by=1),   # Timepoints for evaluation
...
plot(lower.ts.sir[,"time"],lower.ts.sir[,"S"], xlab="Time", ylab="Susceptible", type="l", col="green", ylim=c(0,5e5))
lines(lower.ts.sir[,"time"],lower.ts.sir[,"I"], xlab="Time", ylab="Infected", type="l", col="red")
## uhoh, it's cut off. how can we edit this?
