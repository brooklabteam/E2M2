...
## (2) Take a look at the form of the dataset
head(dat)

## (3) Select a subset of these data, choosing just those with R0 value = 2 and name that object "dat.R0"
dat.R0 <- subset(dat, R0==2)
head(dat.R0)

## (4) Next,  define the length of our time series. Make a vector titled "time" that is the length of 
...
## (5) Now, define a variable called "N" that equals your population size
N=26
