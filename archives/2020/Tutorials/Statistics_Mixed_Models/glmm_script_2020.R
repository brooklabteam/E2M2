...
setwd('C:/Users/Garchito/Documents/Teaching and courses/E2M2 2020/Statistics mixed models/')
...
# We'll check a multivariate model that includes number of medical staff and all time-dependent variables 
...
# Let's look at one coefficient and it's 95% confidence intervals
...
# We need to prepare a little the database in order to add NAs into the residuals' structure
